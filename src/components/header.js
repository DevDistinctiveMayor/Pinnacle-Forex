      ...
      <div className="client-review-container">
          <div className="flex justify-center">
            <div class="mt-[8rem] flex justify-center md:flex-row flex-col ">
              <h2 className="text-[20px] lg:text-[1.7rem] font-bold text-center md:mt-[6rem] text-slate-300 font-mono  lg:[30rem] md:w-[30rem] sm:w-[20rem] w-[16rem]">EXPERIENCE OUR WINNING ONLINE TRADING PLATFORM.<br/>
